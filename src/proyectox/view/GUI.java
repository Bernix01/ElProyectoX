...
public class GUI extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		noexisteLayout.setHorizontalGroup(noexisteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(noexisteLayout.createSequentialGroup().addGap(187, 187, 187).addComponent(progreso)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						noexisteLayout.createSequentialGroup().addContainerGap(63, Short.MAX_VALUE)
								.addGroup(noexisteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
												noexisteLayout.createSequentialGroup().addComponent(jLabel3).addGap(43,
														43, 43))
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, noexisteLayout
										.createSequentialGroup().addComponent(BtnOK).addGap(210, 210, 210)))));
		noexisteLayout.setVerticalGroup(noexisteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(noexisteLayout.createSequentialGroup().addGap(53, 53, 53).addComponent(jLabel3)
						.addGap(18, 18, 18).addComponent(progreso).addGap(18, 18, 18).addComponent(BtnOK)
		...
		javax.swing.GroupLayout resumenEncontradoLayout = new javax.swing.GroupLayout(
				resumenEncontrado.getContentPane());
		resumenEncontrado.getContentPane().setLayout(resumenEncontradoLayout);
		resumenEncontradoLayout.setHorizontalGroup(resumenEncontradoLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, resumenEncontradoLayout.createSequentialGroup()
						.addContainerGap(110, Short.MAX_VALUE)
						.addGroup(resumenEncontradoLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
								.addComponent(jLabel2)
								.addGroup(resumenEncontradoLayout.createSequentialGroup()
										.addComponent(BtnAnteriorResumen, javax.swing.GroupLayout.PREFERRED_SIZE, 213,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(BtnNuevoResumen, javax.swing.GroupLayout.PREFERRED_SIZE, 213,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addGap(101, 101, 101)));
		resumenEncontradoLayout
				.setVerticalGroup(resumenEncontradoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(resumenEncontradoLayout.createSequentialGroup().addGap(23, 23, 23)
								.addComponent(jLabel2).addGap(18, 18, 18)
								.addGroup(resumenEncontradoLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(BtnAnteriorResumen).addComponent(BtnNuevoResumen))
		...
		ListaOperacion.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "Consultar top 10 por categoría", "Listar películas por año", "Buscar película",
						"Mostrar películas por orden alfabético descendente",
						"Mostrar películas por año descendente", "Mostrar películas ordenadas por categoría" }));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(106, 106, 106)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jLabel1).addComponent(Label1))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 171, Short.MAX_VALUE)
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								layout.createSequentialGroup()
										.addComponent(Txt1, javax.swing.GroupLayout.PREFERRED_SIZE, 133,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(ListaCategoria, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
						.addComponent(ListaOperacion, javax.swing.GroupLayout.Alignment.TRAILING,
				...
				.addGroup(layout.createSequentialGroup()
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(BtnGenerarReporte).addComponent(comentarioResumen))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(43, 43, 43)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel1).addComponent(ListaOperacion,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								...
								.addComponent(Txt1, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18).addComponent(comentarioResumen)
	...
	private void ListaOperacionActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (ListaOperacion.getSelectedItem().toString()
				.equals("Mostrar películas por orden alfabético descendente")) {
	...
	private void BtnNuevoResumenActionPerformed(java.awt.event.ActionEvent evt) {
		...
		JOptionPane.showMessageDialog(null,
				"Se creará un nuevo resumen, esta operación puede tardar algun tiempo. Por favor espere.");
		ProyectoX.cargar(true);
		BtnGenerarReporte.setVisible(true);
		comentarioResumen.setVisible(false);
	}
	...
	public static void main(String args[]) {
		...
		ProyectoX.generarListaDeAnio(ProyectoX.cargar(false), 2005);
	}
